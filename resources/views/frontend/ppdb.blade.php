<x-frontend-layout>
    <section class="hero-section py-5 text-white">
        <div class="container py-5">
            ...
            <p class="lead mb-0">Enrollment information for prospective students and families.</p>
        </div>
    </section>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-5">
                                <div class="bg-light rounded p-4">
                                    <p class="mb-2"><strong>Open:</strong> {{ $ppdbInfo->registration_open ? $ppdbInfo->registration_open->format('d M Y') : 'TBD' }}</p>
                                    <p class="mb-0"><strong>Close:</strong> {{ $ppdbInfo->registration_close ? $ppdbInfo->registration_close->format('d M Y') : 'TBD' }}</p>
                                </div>
                            </div>
                        </div>
                    @else
