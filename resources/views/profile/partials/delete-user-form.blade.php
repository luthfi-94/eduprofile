<section>
    <header class="mb-3">
        <h2 class="h5 fw-semibold mb-1">{{ __('Delete Account') }}</h2>
            ...
            <div class="modal-content">
                <form method="post" action="{{ route('profile.destroy') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input id="delete_account_password" name="password" type="password" class="form-control @if($errors->userDeletion->has('password')) is-invalid @endif" placeholder="{{ __('Password') }}">
